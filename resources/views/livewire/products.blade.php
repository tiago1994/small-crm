                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 text-center w-32">
                            <i class="la la-pencil cursor-pointer" wire:click="toggleAddModal({{$product->id}})"></i>
                            <i class="la la-trash cursor-pointer ml-1" wire:click="toggleDeleteModal({{$product->id}})"></i>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
                    ...
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        <div class="sm:flex sm:items-start">
                            ...
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                <h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-title">Deletar Produto</h3>
                                <div class="mt-2">
                                    <p class="text-sm text-gray-500">
                                        Deletando este produto você ira perder todo o histórico do mesmo.
                                    </p>
                                </div>
                            </div>
                        </div>
