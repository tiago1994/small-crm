                ...
                <div class="bg-white px-5 pt-5 pb-4">
                    <div>
                        <div class="mt-3 text-center sm:text-left">
                            <h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-title">Criar/Editar Produto</h3>
                            <hr class="mt-2">
                            <div class="w-full mt-3">
                                <input type="text" class="w-full border border-gray-200 rounded shadow-sm" wire:model.defer="product.name" placeholder="Digite o nome do produto..." />
